...
var type = Select ac.type From Athletes a inner join Activities ac ON a.sport = ac.sport Where a.name = 'Usain Bolt';

var sport = SELECT sport FROM Athletes WHERE name = "Usain Bolt"; -- getting the sports of the athletes

var type = SELECT type FROM Pokemon WHERE sport = sport; -- getting the counterpart Pokemon type
